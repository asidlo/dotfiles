...
local function lsp_keymaps(bufnr)
    ...
    vim.api.nvim_buf_set_keymap(bufnr, 'i', '<C-k>', '<cmd>lua require("lsp_signature").toggle_float_win()<CR>', opts)
    vim.api.nvim_buf_set_keymap(bufnr, 's', '<C-k>', '<cmd>lua require("lsp_signature").toggle_float_win()<CR>', opts)
